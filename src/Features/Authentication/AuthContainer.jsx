...
const AuthContainer = () => {
    ...
    const {isPending : isPendingOtp, error, data, mutateAsync} = useMutation({
        mutationFn: GetOtp,
      })
    ...
    const RenderStep = () => {
        switch (step) {
            ...
            case 2:
                return <CheckOTPForm phoneNumber={phoneNumber} OnBackHandler={() => setStep((prev) => prev - 1)} ResendOtpHandler={SendOtpHandler} />       
            default:
                break;
        }
    }
